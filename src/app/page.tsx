...
export default function Home() {
  ...
  const elements: Element[] = useSelector((state: DragsState) => state.drags.elements)
  const drags: Element[] = useSelector((state: DragsState) => state.drags.drags)
  ...
  return (
    <>
        ...
        <div
          className={" scrollbar-hide   flex justify-center items-stretch  md:flex-row flex-col   gap-6 "}
        >
          ...
          <div
            ...
            py-5
            min-w-[280px] w-full md:w-1/2
              text-[#828FA3] mt-[20px] md:mt-[135px] rounded-lg "
          >
          ...
          <div
            className="   
        flex justify-around items-stretch flex-wrap  
        font-bold text-2xl  
        transition duration-300  
        dark:bg-[#2b2c3740] 
         bg-[#E9EFFA] scrollbar-hide       py-5
          min-w-[280px] w-full md:w-1/2 
          text-[#828FA3]  md:mt-[135px] rounded-lg "
            ref={drop}
          >
            {drags.map((el, index) => (
        ...
        <div className="my-5 text-center">
          <button
            onClick={() => save()}
            className="w-1/3   items-center dark:text-[#635fc7] dark:bg-white  text-white bg-[#635fc7] py-2 rounded-full "
          >
            Save
          </button>
        </div>
        ...
        <div
          className={" scrollbar-hide   flex  justify-start items-center  "}
        >
          ...
          <div
            ...
            dark:bg-[#2b2c3740] 
             bg-[#E9EFFA] scrollbar-hide   
              min-w-[280px] w-full  md:w-3/4 m-auto
              text-[#828FA3]   rounded-lg "
          >
            {tasks.map(task => (<Ele3 id={task.id} key={task.id} text={task.text} type={task.text == "Checked" ? "checkbox" : "text"} />))}
